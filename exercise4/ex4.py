...
os.system('fstcompose 4.encoded1.fst 4c.fst 4c2.fst')
os.system('fstproject --project_output 4c2.fst 4c3.fst')
os.system('fstrmepsilon 4c3.fst | fstdeterminize | fstminimize - 4c4.fst')

fout, out = open('4cresult.txt', 'w'), ''
f = os.popen('fstinfo 4c3.fst | head -n 6 | tail -n 2')
out += f.read()
f = os.popen('fstinfo 4c4.fst | head -n 6 | tail -n 2')
out += f.read()
fout.write(out)
fout.close()

os.system('fstdraw --portrait --nodesep=0.01 --height=15 --isymbols=table4.txt --osymbols=table4.txt 4c4.fst 4c4.dot')
os.system('dot -Tps 4c4.dot > 4c4.ps')

# os.system('printstrings.O2 --label-map=table4.txt --input=4c4.fst -n 10 -w')

# 4d
os.system('fstcompose 4c4.fst 4.lm.fst 4d.fst')
